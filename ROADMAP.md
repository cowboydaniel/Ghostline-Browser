...
1. **Foundation (Months 0–3):** build the initial rendering engine and networking stack from scratch; integrate RFP baseline; enable site isolation; enforce partitioned cookies/storage; build sandbox profiles; set up signing and reproducible build pipeline.
